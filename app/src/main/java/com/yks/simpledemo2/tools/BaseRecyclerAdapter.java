...
/**
 * 描述：recyclerview的adapter封装
 * 作者：zzh
 * 参考文档：https://blog.csdn.net/runstoppable/article/details/80236090
 * time:2019/05/06
 */
public abstract class BaseRecyclerAdapter<T> extends RecyclerView.Adapter<BaseRecyclerAdapter.BaseViewHolder> {
    ...
    protected int mItenId;
    protected OnItemClickListner onItemClickListner;//单击事件

    public BaseRecyclerAdapter(List<T> mDatas,int itemId) {
        this.mDatas = mDatas;
        this.mItenId = itemId;
